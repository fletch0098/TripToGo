...
if ( ! function_exists( 'hestia_subscribe' ) ) :
	...
	function hestia_subscribe() {
		...
		if ( current_user_can( 'edit_theme_options' ) ) {
			...
			$hestia_subscribe_subtitle = get_theme_mod( 'hestia_subscribe_subtitle', sprintf( esc_html__( 'Change this subtitle in %s.','hestia-pro' ), sprintf( '<a href="%1$s" class="default-link">%2$s</a>', esc_url( admin_url( 'customize.php?autofocus&#91;control&#93;=hestia_subscribe_subtitle' ) ), esc_html__( 'customizer','hestia-pro' ) ) ) );
		} else {
