...
function hestia_features_register_strings() {
	$default = apply_filters( 'hestia_features_default_content', json_encode( array(
		array(
...
function hestia_testimonials_register_strings() {
	$default = apply_filters( 'hestia_testimonials_default_content', json_encode( array(
		array(
...
function hestia_team_register_strings() {
	$default = apply_filters( 'hestia_team_default_content', json_encode( array(
		array(
