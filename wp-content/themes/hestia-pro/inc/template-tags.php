			...
			<div class="media-body">
				<h4 class="media-heading">
					...
					<small>
						...
						printf( esc_html__( '&#183; %1$s at %2$s', 'hestia-pro' ),
							get_comment_date(),
							get_comment_time()
						);
	...
	function hestia_comments_template() {
		...
		$args     = array(
			...
			'must_log_in'        => '<p class="must-log-in">' .
			                        ...
			                        sprintf( wp_kses( __( 'You must be <a href="%s">logged in</a> to post a comment.', 'hestia-pro' ), array(
				                        'a' => array(
					                        'href' => array(),
				                        ),
