...
function hestia_advanced_colors_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new Hestia_Customize_Alpha_Color_Control( $wp_customize, 'secondary_color', array(
	...
	$wp_customize->add_control( new Hestia_Customize_Alpha_Color_Control( $wp_customize, 'body_color', array(
	...
	$wp_customize->add_control( new Hestia_Customize_Alpha_Color_Control( $wp_customize, 'header_overlay_color', array(
	...
	$wp_customize->add_control( new Hestia_Customize_Alpha_Color_Control( $wp_customize, 'header_text_color', array(
	...
	$wp_customize->add_control( new Hestia_Customize_Alpha_Color_Control( $wp_customize, 'navbar_background_color', array(
	...
	$wp_customize->add_control( new Hestia_Customize_Alpha_Color_Control( $wp_customize, 'navbar_text_color', array(
	...
	$wp_customize->add_setting( 'navbar_transparent_text_color', array(
		'default'           => '#fff',
		'sanitize_callback' => 'hestia_sanitize_colors',
	) );

	$wp_customize->add_control( new Hestia_Customize_Alpha_Color_Control( $wp_customize, 'navbar_transparent_text_color', array(
