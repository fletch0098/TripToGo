...
function hestia_portfolio_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'hestia_portfolio_hide', array(
		'sanitize_callback' => 'hestia_sanitize_checkbox',
		'default' => true,
	) );

	$wp_customize->add_control( 'hestia_portfolio_hide', array(
		'type' => 'checkbox',
