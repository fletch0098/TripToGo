...
function hestia_register_big_title_partials( $wp_customize ) {
	$wp_customize->selective_refresh->add_partial( 'hestia_big_title_title', array(
		'selector'            => '.carousel .title',
		'settings'            => 'hestia_big_title_title',
		'render_callback'     => 'hestia_big_title_title_render_callback',
	) );

	$wp_customize->selective_refresh->add_partial( 'hestia_big_title_text', array(
		'selector'            => '.carousel h4',
		'settings'            => 'hestia_big_title_text',
		'render_callback'     => 'hestia_big_title_text_render_callback',
	) );

	$wp_customize->selective_refresh->add_partial( 'hestia_big_title_button', array(
	...
	$wp_customize->selective_refresh->add_partial( 'hestia_big_title_background', array(
