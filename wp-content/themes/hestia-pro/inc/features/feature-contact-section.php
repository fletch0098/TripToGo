...
function hestia_contact_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new Hestia_Page_Editor( $wp_customize, 'hestia_contact_content_new', array(
...
function hestia_register_contact_partials( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'hestia_contact_background', array(
		'selector' => '.contact-image',
		'settings' => 'hestia_contact_background',
		'render_callback' => 'hestia_contact_image_callback',
	) );

	$wp_customize->selective_refresh->add_partial( 'hestia_contact_info', array(
